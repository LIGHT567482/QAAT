...
- Name: auth.spec.ts >> Authentication >> Unauthenticated access redirects to /login
- Location: specs/auth.spec.ts:38:7
...
Received string:  "http://localhost:3001/qa/live"
Timeout: 5000ms

Call log:
  - Expect "toHaveURL" with timeout 5000ms
    13 × locator resolved to <html>…</html>
       - unexpected value "http://localhost:3001/qa/live"
