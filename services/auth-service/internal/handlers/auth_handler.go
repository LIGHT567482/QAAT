...
func NewAuthHandler(users *store.UserStore, tokens *store.TokenStore, jwt *crypto.JWTService, jwtTTL time.Duration) *AuthHandler {
	return &AuthHandler{users: users, tokens: tokens, jwt: jwt, jwtTTL: jwtTTL}
}
...
func (h *AuthHandler) Login(w http.ResponseWriter, r *http.Request) {
	...
	// TOTP gate: required for VC and DQA_DIRECTOR.
