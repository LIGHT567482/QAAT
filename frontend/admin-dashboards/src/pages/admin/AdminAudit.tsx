...
const LABEL: Record<string, string> = {
  ...
  // U-PANEL INTEGRATION: DEFERRED TO V2 — nothing writes these actions while the integration is
  // suspended, so their labels are commented out with it. Rows already in the trail keep their
  // raw action name until this is restored; history is never rewritten.
