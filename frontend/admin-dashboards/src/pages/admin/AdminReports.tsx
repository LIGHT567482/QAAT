...
export default function AdminReports() {
  ...
  const cards = [
    // STUDENT MODULE: DEFERRED TO V2 — the report it points at is suspended, so the card is out
    // of the hub rather than leading somewhere that only explains itself once you arrive.
    ...
    { to: `${t}/lecturer-attendance`, title: 'Lecturer Attendance', desc: 'Lecturer contact hours from coordinator logs and the QA monitor round.' },
    { to: `${t}/employee-attendance`, title: 'Employee Attendance', desc: 'General staff check-in/out from the biometric tablet.' },
