...
export default function OrgOverview({ level }: { level: 'hod' | 'dean' | 'qa-dept' | 'qa-school' }) {
  ...
  // STUDENT MODULE: DEFERRED TO V2 — the exam-eligibility bar, read only by the at-risk section.
  // const threshold = k.threshold || 75

  // STUDENT MODULE: DEFERRED TO V2 — only the at-risk section below read this.
  ...
  return (
    <div>
      ...
      <Section title="Is teaching happening?" hint="sessions actually held against the timetable">
        ...
        {/* STUDENT MODULE: DEFERRED TO V2 — this whole section is the student exam-eligibility bar.
            Commented out, not deleted; restore it with the student module. */}
        {/*
        ection
