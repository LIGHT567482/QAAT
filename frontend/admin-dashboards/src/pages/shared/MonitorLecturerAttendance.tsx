...
interface Summary {
  ...
  // `patrolled`, not `monitored` — the name the Go handler actually emits
  // (lecturer_patrol_attendance.go, `json:"patrolled"`). It was declared as `monitored` here, so
  // the Monitored column rendered undefined and the headline NaN on every dashboard that mounts
  // this page. The screen wording stays "Monitored"; the wire name is not ours to choose.
