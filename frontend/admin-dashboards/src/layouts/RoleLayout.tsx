...
const NAV: Record<Role, NavLink[]> = {
  ...
  VC: [
    ...
    // DEFERRED TO V2 — { label: 'Check-in Attempts',   path: '/vc/checkin-attempts' },
  ...
  DQA_DIRECTOR: [
    ...
    // DEFERRED TO V2 — { label: 'Check-in Attempts',   path: '/dqa/checkin-attempts' },
  ...
  QA_OFFICER: [
    ...
    // DEFERRED TO V2 — { label: 'Check-in Attempts',   path: '/qa/checkin-attempts' },
...
function adminNav(): NavLink[] {
  ...
  return [
    ...
    // DEFERRED TO V2 — { label: 'Check-in Attempts',   path: '/admin/checkin-attempts' },
