...
/** Finds the coordinator's in-room server on the hotspot LAN (NSD "_qaat._tcp", with a fallback
 *  probe of 192.168.43.1 / 192.168.49.1:8080). Returns "http://host:port" or null. */
