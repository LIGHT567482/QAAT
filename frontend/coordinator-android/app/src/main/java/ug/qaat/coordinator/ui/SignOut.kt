...
fun performSignOut() {
    ...
    // Nothing to stop: the coordinator no longer runs a foreground service, because it no
    // longer runs a hotspot or an in-room server. Attendance goes to the gateway.
